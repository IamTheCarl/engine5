...
fn fragment(in: FragmentInput) -> @location(0) vec4<f32> {
    ...
    pbr_input.material.base_color = textureSample(color_texture_array, color_texture_array_sampler, in.uv, i32(in.texture_layer));
    ...
    pbr_input.N = array_texture_apply_normal_mapping(
